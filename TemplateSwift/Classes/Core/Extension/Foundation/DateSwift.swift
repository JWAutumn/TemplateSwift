...
extension Date: DYSwiftCompatibleValue {}

public extension DYSwiftWrapper where Base == Date {
...
public extension DYSwiftWrapper where Base == Date {
    ...
    /// 当前时间转字符串
    ///
    ///     Date().dy.string() -> "2020-05-31 15:16:28"
    ///     Date().dy.string(withFormat: "yyyy-MM-dd") -> "2020-05-31"
    ///
    /// - Parameter format: 格式
    /// - Returns: 日期格式字符串
    ...
    /// 时间转字符串
    ///
    ///     Date.dy.string(fromDate: Date()) -> "2020-05-31 15:18:03"
    ///     Date.dy.string(fromDate: Date(), format: "yyyy-MM-dd") -> "2020-05-31"
    ///
    /// - Parameters:
    ///   - date: 时间
    ///   - format: 格式
    ...
    /// 时间字符串转时间
    ///
    ///     Date.dy.date(fromString: "2020-05-31", format: "yyyy-MM-dd") -> Date
    ///
    /// - Parameters:
    ///   - string: 字符串
    ///   - format: 格式
